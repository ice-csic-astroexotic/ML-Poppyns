...
def generate_htcondor_failed(args: argparse.Namespace) -> None:
    ...
    if args.type_simulation == "dyn":
        ...
        exec_command = "python /data/magnesia/software/MAGNESIA_population_synthesis/mlpoppyns/simulator/simulate_population_dyn.py --save_dir $1 --parameter_override $2  \n"
