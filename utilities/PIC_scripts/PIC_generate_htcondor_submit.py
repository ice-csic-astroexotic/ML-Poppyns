...
def generate_wrapper(
    ...
    if type_simulation == "dyn":
        ...
        exec_command = "python /data/magnesia/software/MAGNESIA_population_synthesis/pypopsyn/simulator/simulate_population_dyn.py --save_dir ${a[0]} --parameter_override ${a[1]}  \n"
