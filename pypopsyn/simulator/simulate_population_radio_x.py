    ...
    with timewith.TimeWith(
        ...
        while (
            ...
            with timewith.TimeWith(
                ...
                idx_det_radio = idx[coverage_radio]
                idx_det_x = idx[coverage_x]

                age_det = age_datab[coverage_tot]
                ra_det = ra_datab[coverage_tot]
                dec_det = dec_datab[coverage_tot]
                ...
                coverage_x = coverage_x[coverage_tot]
                ...
                age_det_radio = age_det[coverage_radio]
                P_det_radio = P_det[coverage_radio]
                l_det_radio = l_det[coverage_radio]
                b_det_radio = b_det[coverage_radio]
                dist_det_radio = dist_det[coverage_radio]
                B_det_radio = B_det[coverage_radio]
                chi_det_radio = chi_det[coverage_radio]
                ...
                idx_det_PMPS = idx_det_radio[detected_radio_PMPS]
                idx_det_SMPS = idx_det_radio[detected_radio_SMPS]
                idx_det_HTRU_low = idx_det_radio[detected_radio_HTRU_low]
                idx_det_HTRU_mid = idx_det_radio[detected_radio_HTRU_mid]
                idx_det_HTRU_high = idx_det_radio[detected_radio_HTRU_high]
                ...
                update_dictionary_detected_PMPS = {
                    ...
                    "B": B_det_radio[detected_radio_PMPS].tolist(),
                    "chi": chi_det_radio[detected_radio_PMPS].tolist(),
                    "P": P_det_radio[detected_radio_PMPS].tolist(),
                    "Pdot": P_dot_det_radio[detected_radio_PMPS].tolist(),
                ...
                update_dictionary_detected_SMPS = {
                    ...
                    "B": B_det_radio[detected_radio_SMPS].tolist(),
                    "chi": chi_det_radio[detected_radio_SMPS].tolist(),
                    "P": P_det_radio[detected_radio_SMPS].tolist(),
                    "Pdot": P_dot_det_radio[detected_radio_SMPS].tolist(),
                ...
                update_dictionary_detected_HTRU_low = {
                    ...
                    "B": B_det_radio[detected_radio_HTRU_low].tolist(),
                    "chi": chi_det_radio[detected_radio_HTRU_low].tolist(),
                    "P": P_det_radio[detected_radio_HTRU_low].tolist(),
                    "Pdot": P_dot_det_radio[detected_radio_HTRU_low].tolist(),
                ...
                update_dictionary_detected_HTRU_mid = {
                    ...
                    "B": B_det_radio[detected_radio_HTRU_mid].tolist(),
                    "chi": chi_det_radio[detected_radio_HTRU_mid].tolist(),
                    "P": P_det_radio[detected_radio_HTRU_mid].tolist(),
                    "Pdot": P_dot_det_radio[detected_radio_HTRU_mid].tolist(),
                    "L_radio_bol": L_radio_bol[
                        detected_radio_HTRU_mid
                    ].tolist(),
                ...
                update_dictionary_detected_HTRU_high = {
                    ...
                    "B": B_det_radio[detected_radio_HTRU_high].tolist(),
                    "chi": chi_det_radio[detected_radio_HTRU_high].tolist(),
                    "P": P_det_radio[detected_radio_HTRU_high].tolist(),
                    "Pdot": P_dot_det_radio[detected_radio_HTRU_high].tolist(),
                    "L_radio_bol": L_radio_bol[
                        detected_radio_HTRU_high
                    ].tolist(),
                ...
                age_det_x = age_det[coverage_x]
                P_det_x = P_det[coverage_x]
                ra_det_x = ra_det[coverage_x]
                ...
                log.info(
                    f"Total number of neutron stars detected by an x-ray survey: {n_detected_sim_x}"
                )

                idx_det_x = idx_det_x[detected_x]

                idx_det_x = df_index["index position"][idx_det_x].values

                update_dictionary_detected_x = {
                    "age": age[idx_det_x].tolist(),
                    "ra": ra_final[idx_det_x].tolist(),
                    "dec": dec_final[idx_det_x].tolist(),
                    "l": l_final[idx_det_x].tolist(),
                    "b": b_final[idx_det_x].tolist(),
                    "N_H": N_H[detected_x].tolist(),
                    "dist": sun_dist_icrs[idx_det_x].tolist(),
                    "pm_ra": pm_ra_final[idx_det_x].tolist(),
                    "pm_dec": pm_dec_final[idx_det_x].tolist(),
                    "v_ls": v_ls_icrs[idx_det_x].tolist(),
                    "B": B_det_x[detected_x].tolist(),
                ...
                # Update the dictionary containing the detection information.
                dictionary_detected_x = {
                    key: value + update_dictionary_detected_x[key]
                ...
                idx_det_radio = idx_det_radio[detected_radio]
                idx_det_tot = list(set(idx_det_radio).union(set(idx_det_x)))
        ...
        log.info(
            f"Galactic neutron star birth rate per century according to x-ray survey: {birth_rate_x} neutron stars per century."
        )
        ...
        with timewith.TimeWith(
            ...
            header_final_x = pd.MultiIndex.from_arrays(
                [parameters_final_x, units_final_x]
            )
            ...
            df_x = pd.DataFrame.from_dict(data=dictionary_detected_x)
            df_x.columns = header_final_x
            ...
            x_output_path = pathlib.Path().joinpath(
                output_path, "survey_x_results.pkl.gz"
            )
            df_x.to_pickle(x_output_path, compression="gzip")
            ...
            log.info(
                f"Output of the detected population with an x-ray survey generated in {os.getcwd()}/{x_output_path}"
            )
