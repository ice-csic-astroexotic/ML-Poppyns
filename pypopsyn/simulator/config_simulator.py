...
cfg["P_initial_log10_mean"]: float = -1.00
cfg["P_initial_log10_sigma"]: float = 0.38
...
cfg["B_initial_log10_sigma"]: float = 0.45
...
cfg[
    ...
    35.5  # [erg s^(3 * epsilon_L - 1) ] if pdf_luminosity_radio_ppdot is used.
)
