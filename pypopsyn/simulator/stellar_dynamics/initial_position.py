...
def calculate_r_phi_spiral_model(
    ...
    # Since the spiral arm as a shorter extent in r coordinate compared to the other arms,
    # we need to draw the r position of the stars in the local arm in the range [local_r_min, local_r_max].
    if NS_local != 0:
