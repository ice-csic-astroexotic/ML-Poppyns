"""
    ...
    input features into a latent vector. The neural network is composed of 3 sets of convolutional layers after a
    max-pool layer, followed by a fully connected layer that will serve as the latent vector.
