...
class BaseTrainer:
    def __init__(self, model, criterion, metrics, optimizer, configuration):
        ...
        self.device, device_ids = self._prepare_device(configuration["n_gpu"])
        ...
        self.monitor = trainer_configuration.get("monitor", "off")
