    ...
    def __getitem__(
        ...
        for col in self.dataset.columns:
            ...
            if "input:" in col:
                ...
                if "xray" in col:
                    channel_2 = np.array(Image.open(channel_filename))[:, :, 0]
                    channels_2.append(channel_2)
                else:
                    channel_1 = np.array(Image.open(channel_filename))[:, :, 0]
        ...
        image_1 = np.dstack(channels_1)
        image_2 = np.dstack(channels_2)
