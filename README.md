...
5. machine. To this end, open the configuration file `pypopsyn/simulator/config_simulator.py`, scroll to the section 
6. titled "GENERAL SIMULATION PARAMETERS" (specifically lines 49 and 50) and add the absolute path to the repository 
7. folder by modifying the variable `cfg["path_to_software"]`. 

5. If you also want to use the code to perform machine learning experiments with simulation-based inference, you will 
6. need to install the [Simulation Based Inference (SBI)](https://sbi-dev.github.io/sbi/) library after activating the 
7. environment by running:
   ```
