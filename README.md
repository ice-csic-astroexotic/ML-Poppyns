...
For logging informatio to both console and file outputs we make use of Pyhton's
...
```
(pop_syn) agarcia@challenger:~/Workspace/MAGNESIA_population_synthesis$ python examples/simulator/generating_population.py hydra.verbose=pypopsyn.simulator.initial_pulation
