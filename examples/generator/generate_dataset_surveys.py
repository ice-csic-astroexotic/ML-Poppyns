...
def create_survey_maps(
    ...
    """
    This method reads the simulated survey files (usually generated by the simulation helper)
...
def generate_dataset(args) -> None:
    """
    This method reads the simulated population files (usually generated by the simulation helper) folder
    and generates a dataset of density maps in the specified format (images or arrays) and with a specified resolution.
