...
def create_survey_maps(
    ...
    Args:
        ...
        resolution_ppdot(int): Resolution (number of bins per axis for the 2D histograms) for the P-Pdot maps.
    ...
    if survey_type == "radio":
        ...
        if filter_young_xdins:
            ...
            filter_mask = np.ones(len(d_x_sim), dtype=bool)
        ...
        dmap.generate_density_map(
            ...
            sample_number,
            data_type,
            df_survey["ra"][filter_mask],
            df_survey["dec"][filter_mask],
            resolution_dyn,
            int(resolution_dyn / 2),
            x_log_scale=False,
            y_log_scale=False,
        ...
        wdmap.generate_weighted_density_map(
            ...
            df_survey["ra"][filter_mask],
            df_survey["dec"][filter_mask],
            abs(df_survey["pm_ra"][filter_mask]),
            w_min=0.0,
            x_resolution=resolution_dyn,
            y_resolution=int(resolution_dyn / 2),
            x_log_scale=False,
        ...
        wdmap.generate_weighted_density_map(
            ...
            df_survey["ra"][filter_mask],
            df_survey["dec"][filter_mask],
            abs(df_survey["pm_dec"][filter_mask]),
            w_min=0.0,
            x_resolution=resolution_dyn,
            y_resolution=int(resolution_dyn / 2),
            x_log_scale=False,
        ...
        dmap.generate_density_map(
            ...
            sample_number,
            data_type,
            df_survey["P"][filter_mask],
            df_survey["P_dot"][filter_mask],
            resolution_ppdot,
            resolution_ppdot,
            x_log_scale=True,
            y_log_scale=True,
        ...
        wdmap.generate_weighted_density_map(
            ...
            df_survey["P"][filter_mask],
            df_survey["P_dot"][filter_mask],
            np.log10(df_survey["S_x_rcs_abs"][filter_mask]),
            w_min=-17,
            x_resolution=resolution_ppdot,
            y_resolution=resolution_ppdot,
            x_log_scale=True,
