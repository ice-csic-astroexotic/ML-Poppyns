...
::
  ...
  python pypopsyn/generator/generate_dataset.py --data simulated_data --save_dir generated_dataset --data_type array --resolution_dyn 64 --resolution_ppdot 32
...
To do this you can run the :code:`dataset_splitter.py` script in the :code:`utilities` folder.
...
::
 ...
 python utilities/dataset_splitter.py --dataset_path generated_dataset --valid_split 0.2
...
::
 ...
 python utilities/dataset_splitter.py --dataset_path generated_dataset --test_split 0.1 --valid_split 0.2
...
::
  ...
  python utilities/experiment_launcher.py --command_list pypopsyn/generator/experiment_list.txt --processes 2
