...
+================+============+=================+
| Initialization | 1.206      | 1.2852          |
+----------------+------------+-----------------+
| Initial Energy | 1.383      | 2.590           |
+----------------+------------+-----------------+
| Export Initial | 0.214      | 2.804           |
+----------------+------------+-----------------+
|                |            |                 |
+----------------+------------+-----------------+
| Evolve Pop.    | 11.749     | 11.749          |
+----------------+------------+-----------------+
| Evolved Energy | 0.0024     | 11.752          |
+----------------+------------+-----------------+
| Export Evolved | 0.3428     | 12.095          |
+----------------+------------+-----------------+
|                |            |                 |
+----------------+------------+-----------------+
| Total          |            | 15.186          |
