...
NumPy array. The maps generated by this script contain the spatial density and velocity information for all evolved 
neutron stars as well as their distribution and corresponding radio fluxes in the $P-\dot{P}$ plane.
They are the following:

* One position density map in galactocentric $x$ and $y$ coordinates.
* One position density map in galactocentric $x$ and $z$ coordinates.
* One position density map in galactocentric $x$ and $y$ coordinates weighted by the radial velocity component $v_r$.
* One position density map in galactocentric $x$ and $y$ coordinates weighted by the azimuthal velocity component $v_{\phi}$.
* One position density map in galactocentric $x$ and $y$ coordinates weighted by the velocity component $v_z$. 
* One position density map in ICRS coordinates.
* One position density map in ICRS coordinates weighted by the proper motion component $\mu_{\rm RA}$.
* One position density map in ICRS coordinates weighted by the proper motion component $\mu_{\rm DEC}$.
* One e $P-\dot{P}$ density map.
* One $P-\dot{P}$ density map weighted by the logarithm of the radio flux.
...
* Three position density maps in ICRS coordinates weighted by the proper motion component $\mu_{\rm RA}$: one for each of the three radio surveys modeled by the simulator.
* Three position density maps in ICRS coordinates weighted by the proper motion component $\mu_{\rm DEC}$: one for each of the three radio surveys modeled by the simulator.
