...
```commandline
python pypopsyn/learning/sbi_infer.py --trained_model data/example_learning_sbi/models/SBI_ConvolutionMDN/20240626_105721/trained_model.pickle --corner_plot True
```
