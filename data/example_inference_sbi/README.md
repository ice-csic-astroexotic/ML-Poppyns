...
```commandline
python pypopsyn/learning/infer_sbi.py --trained_model data/example_learning_sbi/models/SBI_ConvolutionMDN/20240625_115929/trained_model.pickle --corner_plot True
```
