...
This is an example of magneto-rotational plus detection simulation run with the `simulate_population_magrot_det.py` script and using the default parameters in the configuration file.
